      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/solutions" className="text-gray-400 hover:text-white transition-colors text-sm">Solutions</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Tally ERP Solutions</li>
              <li>Marg ERP Services</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} CAMTIT Solutions. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
